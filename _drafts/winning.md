...
_Taking cues from general strategies about winning, and applying them to software development._
...
The notion of winning or losing is timeless, and has been relevant in all the struggles of humankind through the ages, ranging from friendly games to deadly wars.
...
You probably find yourself working in a fast-paced, continuously-changing industry.
You might not be interested in every new programming language or plugin that comes out, but even if your work is highly specialised, or your environment is very stable, you can probably benefit from at least _some_ of the breakthroughs or insights to be had in other fields.
...
To get in some extra practice, as a few ideas, you can do [Code Katas](http://codekata.com/), get involved in open source software, and work on side projects.
...
Most likely though, you will need to find a way to work The Way into your work-life balance, lest [burnout](https://www.psychologytoday.com/us/basics/burnout) rear its ugly head.

In the best case scenario, your workplace might let you carve out some time for regular practice.
...
Do you normally take a few minutes to browse the internet over coffee in the morning?
Are you waiting for a slow compiler, or
...
Similarly, while you should definitely not blindly try to incorporate every new tech stack, architecture or design pattern that you read about on your main project, you might occasionally see an opportunity to try something new that you have learnt about in the code you're writing.
...
Every bit puts you ahead of the curve;
...
It wouldn't be much fun if you couldn't lose!
...
We do this by making certain types of mistakes impossible.
...
War, for better or for worse, is an excellent judge for evaluating a particular winning strategy.
When battles have been won and lost by adherence to some words of wisdom, that really vouches for their value.
...
_Divide ut regnes. Separa et impera. Divide and rule._

The advice works well in warfare, politics, sports, and many other situations of conflict, for obvious reasons.
When faced with a single, unified enemy, your chance of success is directly correlated to how formidable that foe is.
But break the enemy up, divide them into factions, and each part now only poses a fraction of the original threat.
...
So what?
It was fluke!
Had the hare demanded a rematch, I was sure the tortoise's defeat would have been utterly devastating.

But I am now beginning to understand that it is not the lesson -- slow and steady wins the race -- that is at fault here.
...
They decided to have a race: whoever leads the first expedition to reach the South Pole would win.
And, although they were headed for the same destination, their journeys were quite different.
Scott tried to win by going as fast as possible, everything considered:
on days when his team was well-rested, when there was good weather and the terrain was easy, he pushed hard and covered a lot ground.
...
[Collins and Hansen](https://www.jimcollins.com/books/great-by-choice.html) found that what really makes or breaks a business -- especially when the going gets tough -- is having a plan, and then sticking to it with unwavering, fanatic discipline. 
